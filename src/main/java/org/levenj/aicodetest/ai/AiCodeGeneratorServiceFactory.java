...
import org.levenj.aicodetest.guardrail.PromptSafetyInputGuardrail;
import org.levenj.aicodetest.guardrail.RetryOutputGuardrail;
...
//                        .outputGuardrails(new RetryOutputGuardrail()) // 添加输出护轨，为了流式输出，这里不使用
            ...
            default -> throw new BusinessException(ErrorCode.SYSTEM_ERROR,
                    "不支持的代码生产类型：" + codeGenType.getValue());
        };
    }
